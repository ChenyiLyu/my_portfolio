    ...
    <div id="about" className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            Hello! I am Eva👋. I am currently a first year Master student at New York University, NYC. I study Data Science.

            Meanwhile, I am interested in software developing (I am seeking a Full-Stack internship position for 2022 summer!🚀). 

            I come from a interdisciplinary engineer background; I am passionate about exploring every tech stack🔥.
